...
def get_service_reply(user_id, intent):
    ...
    Вежливо, коротко и структурировано отвечай клиенту на его вопрос, используя информацию из файла, но не говори, что берёшь её из файла. Если информации недостаточно, добавляй только то, что соответствует теме услуги. 
    Когда клиент спрашивает про услугу, давай краткое описание с главной информацией касательно неё, не более одного абзаца. 
