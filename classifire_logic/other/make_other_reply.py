...
def get_other_reply(user_id, user_message):
    prompt = f"""Поддержи диалог с пользователем в рамках обговорённых правил.
                В том числе придерживайся правил доброжелательности из самого первого сообщения системного сообщения.
                ...
                Если он уже в процессе записи, возвращай его именно на тот уровень, на котором он остановился
                """
